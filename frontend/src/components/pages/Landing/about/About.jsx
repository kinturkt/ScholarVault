            ...
            <div className="col-lg-4 col-md-6  m-b30">
              ...
              >
                ...
                <div className="dz-info">
                  ...
                  <h4 className="dz-title">Sanketh Bolishetti </h4>
                  <p>
                    {' '}
            ...
            <div className="col-lg-4 col-md-6  m-b30">
              ...
              >
                ...
                <div className="dz-info">
                  ...
                  <h4 className="dz-title">Pradeep Akula</h4>
                  <p>
                    {' '}
                    Thesis Contributed:10 <br></br>Thesis Reviewed:12<br></br>
                    Since 2024
            ...
            <div className="col-lg-4 col-md-6  m-b30">
              ...
              >
                ...
                <div className="dz-info">
                  ...
                  <h4 className="dz-title">Soumya Reddy Bheemreddy</h4>
                  <p>
                    {' '}
                    Thesis Contributed:10 <br></br>Thesis Reviewed:12<br></br>
                    Since 2024
            ...
            <div className="col-lg-4 col-md-6  m-b30">
              ...
              >
                ...
                <div className="dz-info">
                  ...
                  <h4 className="dz-title">Kausheel Bhagavathula</h4>
                  <p>
                    {' '}
                    Thesis Contributed:10 <br></br>Thesis Reviewed:12<br></br>
                    Since 2024
            ...
            <div className="col-lg-4 col-md-6  m-b30">
              ...
              >
                ...
                <div className="dz-info">
                  ...
                  <h4 className="dz-title">Kintur Ketan Shah</h4>
                  <p>
                    {' '}
            ...
            <div className="col-lg-4 col-md-6  m-b30">
              ...
              >
                ...
                <div className="dz-info">
                  ...
                  <h4 className="dz-title">Madhupriya Bendilli</h4>
                  <p>
                    {' '}
